    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session menu-active  menu-icon-schedule-active">
                        <a href="add_schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Edit Sessions</p></div></a>
                    </td>
                </tr>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:20px;font-weight: 600;">Shedule Manager</p>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if(!($result->num_rows)){
                                    ...
                                    <a class="non-style-link" href="add_schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Sessions &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
